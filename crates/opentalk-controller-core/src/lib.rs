...
#[openapi(
    ...
    components(
        schemas(
            ...
            opentalk_types_api_v1::rooms::by_room_id::PostRoomsRoomserverStartInvitedRequestBody,
            opentalk_types_api_v1::rooms::by_room_id::PostRoomsRoomserverStartRequestBody,
