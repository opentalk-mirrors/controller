...
impl OpenTalkAuthorizerBackend {
    /// Authorize access to the Events collection resource.
    ///
    /// # Access Control List
    ///
    /// Access rights for the [`Events`] resource.
    ///
    /// This resource allows listing and creating events. Any registered user can
    /// access this endpoint, regardless of the access method (read or write).
    ///
    /// | Subject   | Access |
    /// | ----------| ------ |
    /// | **User**  | rw     |
    /// | **Guest** | --     |
    ///
    /// [`Events`]: opentalk_controller_api_authorization::authorization::Resource::Events
    pub(crate) fn authorize_events(&self, authenticated_subjects: SubjectCollection) -> Admission {
...
mod tests {
    ...
    #[case::guest_post(Post, AuthenticationRequired)]
