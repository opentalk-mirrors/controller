...
impl From<opentalk_db_storage::events::shared_folders::NewEventSharedFolder>
    for NewEventSharedFolder
{
    fn from(
        opentalk_db_storage::events::shared_folders::NewEventSharedFolder {
            event_id,
            path,
            write_share_id,
            write_url,
...
impl From<NewEventSharedFolder>
    for opentalk_db_storage::events::shared_folders::NewEventSharedFolder
{
    fn from(
