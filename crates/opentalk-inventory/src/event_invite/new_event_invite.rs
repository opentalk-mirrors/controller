...
impl From<opentalk_db_storage::events::NewEventInvite> for NewEventInvite {
    fn from(
        opentalk_db_storage::events::NewEventInvite {
            event_id,
            invitee,
            role,
            created_by,
...
impl From<NewEventInvite> for opentalk_db_storage::events::NewEventInvite {
    fn from(
        NewEventInvite {
            event_id,
            invitee,
