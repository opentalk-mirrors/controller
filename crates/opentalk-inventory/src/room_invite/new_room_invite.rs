...
impl From<opentalk_db_storage::invites::NewInvite> for NewRoomInvite {
    fn from(
        opentalk_db_storage::invites::NewInvite {
            created_by,
            updated_by,
            room,
            active,
...
impl From<NewRoomInvite> for opentalk_db_storage::invites::NewInvite {
    fn from(
        NewRoomInvite {
            created_by,
            updated_by,
