...
/// A struct containing a stream of a proxied asset download.
pub struct AssetDownloadProxyStream {
...
impl std::fmt::Debug for AssetDownloadProxyStream {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("AssetDownloadProxyStream")
