...
use opentalk_db_storage::{
    events::{
        self as db, EventFavorite, GetEventsCursor, NewEventException, NewEventFavorite,
...
use opentalk_inventory::{
    ...
    EventTrainingParticipationReportParameterSet, NewEvent, error::StorageBackendSnafu,
};
